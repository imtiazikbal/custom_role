                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="card">
                        <div class="card-header">
                            <form method="POST" action="{{ route('users.store') }}" class="was-validated" id="save-form">
                                @csrf
                                <div class="form-row">
                                    <div class="col-sm-5" style="order-right: 1px solid black;">
                                        ...
                                        @endif
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <select name="role[]" id=""class="form-select" multiple aria-label="multiple select example">
